...
// describes a single entity in the hashmap
type Participant struct {
	Host bool 
	Conn *websocket.Conn
}

// main hashmap [roomID string] --> [[]Participant]
type RoomMap struct {
	 Mutex sync.RWMutex
...
// Will return an array of participants in the room
...
//delets the room with the roomID
